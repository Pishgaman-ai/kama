...
export default function ParentDashboardLayout({
  ...
  const [schoolName, setSchoolName] = useState<string | null>(null); // Add this line
  ...
  const isAICommunicationFullScreen =
    pathname === "/dashboard/parent/ai-communication";

  const handleAIClick = () => {
    router.push("/dashboard/parent/ai-communication");
  };
  ...
  const sidebarItems: SidebarItem[] = [
    { icon: Home, label: "داشبورد", href: "/dashboard/parent" },
    { icon: User, label: "فرزندان", href: "/dashboard/parent/children" },
    { icon: BookOpen, label: "آزمون‌ها", href: "/dashboard/parent/exams" },
    { icon: Award, label: "نمرات", href: "/dashboard/parent/grades" },
    {
      icon: Calendar,
      label: "برنامه کلاسی",
    ...
    { icon: Settings, label: "تنظیمات", href: "/dashboard/parent/settings" },
  ];
            ...
            >
              {sidebarItems.map((item) => {
                const isActive =
                  ...
                  (item.href === "/dashboard/parent/ai-communication" &&
                    pathname === "/dashboard/parent/ai-communication");
                  ...
                  <li key={item.label}>
                    {item.href ? (
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-4 p-4 rounded-2xl transition-all duration-300 group text-right ${
                          theme === "dark"
                            ? "text-slate-400 hover:text-white hover:bg-slate-800/50"
                            : "text-gray-600 hover:text-gray-900 hover:bg-gray-100/50"
                        } ${
              ...
              <div>
                ...
                >
                  {pathname === "/dashboard/parent"
                    ? "داشبورد والدین"
                    : pathname === "/dashboard/parent/children"
                    ? "فرزندان"
                    : pathname === "/dashboard/parent/exams"
                    ? "آزمون‌ها"
                    : pathname === "/dashboard/parent/grades"
                    ? "نمرات"
                    : pathname === "/dashboard/parent/schedule"
                    ? "برنامه کلاسی"
                    : pathname === "/dashboard/parent/messages"
                    ? "پیام‌ها"
                    : pathname === "/dashboard/parent/reports"
                    ? "گزارش پیشرفت"
