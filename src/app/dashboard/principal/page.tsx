...
export default function PrincipalDashboardPage() {
  ...
  const stats = dashboardData
    ? [
        ...
        {
          title: "اولیاء",
          value: dashboardData.stats.totalParents.toString(),
          change: "+8",
          changePercent: "+4.2%",
          trend: "up" as const,
          icon: UserCheck,
  ...
  const quickActions = [
    {
      ...
      description: "ایجاد، ویرایش و مدیریت کلاس‌های درسی",
      icon: Users,
    ...
    {
      title: "مدیریت معلمان",
      description: "افزودن و مدیریت اطلاعات معلمان",
      icon: GraduationCap,
    ...
    },
    {
      ...
      description: "آمار و تحلیل عملکرد کلی مدرسه",
      icon: BarChart3,
        ...
        >
          ...
          <div className="space-y-4">
            <div className="text-center py-8">
              ...
              >
                خوش آمدید به پنل مدیریت {dashboardData?.schoolName || "مدرسه"}
              </p>
              <div className="text-center">
                <p
                ...
                >
                  از منوی کناری برای مدیریت مدرسه استفاده کنید
                </p>
              </div>
            </div>
          </div>
