...
export default function AdminUsersPage() {
  ...
  useEffect(() => {
    fetchUsers();
    fetchSchools();
  }, [currentPage, selectedRole, selectedSchool]);
  ...
  const handleSaveUser = async (
    ...
    try {
      ...
      // For both user creation and updates, we need to use FormData to handle file uploads
    ...
    <div className="p-4 sm:p-6 space-y-6" dir="rtl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            <select
              ...
              aria-label="فیلتر بر اساس مدرسه"
              className={`w-full p-2.5 border rounded-lg focus:outline-none focus:ring-2 transition-all ${
                theme === "dark"
                  ? "bg-slate-700/50 border-slate-600 text-white focus:ring-blue-500/50 focus:border-blue-500/55"
                  : "bg-white border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500"
              }`}
            >
      ...
      {users.length === 0 ? (
        ...
        >
          ...
          >
            {searchTerm || selectedRole !== "all" || selectedSchool !== "all"
              ? "کاربری یافت نشد"
              : "هنوز کاربری ندارید"}
          </h3>
          <p
      ...
      {showEditModal && (
        <UserEditModal
          ...
          onSave={(user, profilePictureFile) =>
            handleSaveUser(user, profilePictureFile)
          }
        />
      )}
